...
type Visit = {
  ...
  photos?: any[]; // importante p/ colorir linha
};
                  ...
                  <tbody>
                    {visits
                      ?.filter((v) => {
                        ...
                        // Cultura
                        if (selectedCulture && String(v.culture || "").trim() !== selectedCulture)
                          return false;

                        // Variedade
                        if (selectedVariety && String(v.variety || "").trim() !== selectedVariety)
                          return false;
                      ...
                      ?.map((v) => {
                        ...
                        return (
                          <tr
                            key={v.id}
                            className={hasPhotos ? "table-success" : ""}
                          >
