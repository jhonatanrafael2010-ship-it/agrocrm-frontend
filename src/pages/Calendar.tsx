...
const CalendarCore: React.FC = memo(() => {
  ...
  useEffect(() => {
    ...
    let active = true // controle de desmontagem segura
    ...
    // 🧼 desmonta o calendário corretamente ao sair da rota
    return () => {
      active = false
      const api = calendarRef.current?.getApi?.()
      if (api) {
        api.destroy()
        console.log('🧹 CalendarCore desmontado')
      }
    }
  }, [mounted])
        ...
        <div className="modal-overlay">
          <div className="modal">
            ...
            <div className="modal-actions">
              ...
              <button className="btn-save" onClick={handleCreateVisit}>
                Salvar
              </button>
            </div>
          </div>
